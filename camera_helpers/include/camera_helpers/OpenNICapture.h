...
class OpenNICaptureAll {

typedef void (*ConnectCallback)(OpenNICaptureAll *)  ;
...
private:
    ...
    void input_callback(const sensor_msgs::ImageConstPtr& rgb, const sensor_msgs::ImageConstPtr& depth, const sensor_msgs::PointCloud2ConstPtr &cloud) ;
    void connectCb(ConnectCallback cb) ;
