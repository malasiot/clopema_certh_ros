...
int main(int argc, char **argv) {
	ros::init(argc, argv, "move_constraints_r1");
	ros::NodeHandle n;
...
void setPathConstraints(clopema_arm_navigation::ClopemaMotionPlan & mp) {
	...
	mp.request.motion_plan_req.path_constraints.position_constraints[0].constraint_region_shape.dimensions.push_back(0.05);
	mp.request.motion_plan_req.path_constraints.position_constraints[0].constraint_region_shape.dimensions.push_back(0.05);
